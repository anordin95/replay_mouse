...
from nmz_setup import PRAYER_POTS_FILENAME, RANGE_POTS_FILENAME, ABSORPTION_POTS_FILENAME
...
# Drink 1 absorption pot every 80 seconds
SIP_ABSORTION_EVERY_X_SECONDS = 82.0
...
def replay():
	...
	logging.info(f"Sip a prayer pot every : {absorption_pot_sip_period} seconds.")
	...
	absorption_potion_tracker = get_potion_tracker(ABSORPTION_POTS_FILENAME)
	...
	while True:
		...
		if is_absorption_sip_success == False:
